...
proc create_root_design { parentCell } {
  ...
  set probe6 [ create_bd_port -dir I -from 17 -to 0 probe6 ]
  set probe7 [ create_bd_port -dir I -from 17 -to 0 probe7 ]
  ...
  set probe12 [ create_bd_port -dir I -from 13 -to 0 probe12 ]
